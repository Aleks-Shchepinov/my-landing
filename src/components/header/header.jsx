    ...
    <div className={styles.headerContainer}>
      <a className={styles.headerLogoContainer}>
        ...
        <div className={styles.nameContainer}>
          <a className={styles.name} href="#hero" onClick={handleClick} target="_blank">Александр Щепинов</a>
      ...
      <nav className={`${styles.headerCentralPart} ${isMenuOpen ? styles.mobileOpen : ''}`}>
        <a className={styles.itemCentralPart} href="#hero" onClick={handleClick}>Главная</a>
        <a className={styles.itemCentralPart} href="#about" onClick={handleClick}>Обо мне</a>
        <a className={styles.itemCentralPart} href="#stack" onClick={handleClick}>Стек</a>
        <a className={styles.itemCentralPart} href="#portfolio" onClick={handleClick}>Проекты</a>
        <a className={styles.itemCentralPart} href="#whyme" onClick={handleClick}>Почему я</a>
        <a className={styles.itemCentralPart} href="#contacts" onClick={handleClick}>
          Контакты
        </a>
      </nav>
      <div>
